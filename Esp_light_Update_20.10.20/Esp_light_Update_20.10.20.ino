...
IPAddress staticIP(192, 168, 10, 5); //ESP static ip
IPAddress gateway(192, 168, 10, 1);   //IP Address of your WiFi Router (Gateway)
IPAddress subnet(255, 255, 255, 0);  //Subnet mask
IPAddress dns(8, 8, 8, 8);  //DNS
 
 
const char* ssid = "asman";
const char* password = "menbulut";
const char* deviceName = "LightsBedroom4";
String serverUrl = "192.168.43.252";
String payload;
String device_key = "fvh6a23rbef28732r";
